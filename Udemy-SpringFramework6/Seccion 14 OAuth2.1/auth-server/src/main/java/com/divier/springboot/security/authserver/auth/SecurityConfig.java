package com.divier.springboot.security.authserver.auth;
...
public class SecurityConfig {
	...
	public UserDetailsService userDetailsService() {
		UserDetails userDetails = User.builder().username("pepe").password("{noop}12345").roles("USER")
				.build();
	...
	public RegisteredClientRepository registeredClientRepository() {
		RegisteredClient oidcClient = RegisteredClient.withId(UUID.randomUUID().toString()).clientId("client-app")
